...
{layer==='heatmap'&&heatmap?.features?.length===0&&(<div style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',background:'rgba(255,255,255,0.92)',borderRadius:12,padding:'16px 24px',zIndex:1000,textAlign:'center',boxShadow:'0 2px 12px rgba(0,0,0,0.15)'}}><div style={{fontSize:28}}>🛰️</div><div style={{fontWeight:'bold',color:'#1a237e',fontSize:14,marginTop:4}}>No Satellite Bloom Detected</div><div style={{fontSize:12,color:'#555',marginTop:4}}>Sentinel-2 SFABI shows no bloom signature<br/>in SA coastal waters from the latest pass.</div></div>)}
