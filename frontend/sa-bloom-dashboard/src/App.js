...
const PRIVACY_TEXT="This demonstration prototype does not intentionally collect user analytics for marketing, advertising, profiling, lead generation, retargeting, or behavioural tracking. The site does not require user registration and does not request personal information from users. Basic technical logs may be generated by hosting or security infrastructure for operational, performance, availability, or security purposes only. These logs are not used for marketing purposes.";
const INFO_SECTIONS=[
